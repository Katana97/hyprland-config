...
Singleton {
    ...
    m3colors: QtObject {
        ...
        property color m3primaryContainer: "#d79921"
        property color m3onPrimaryContainer: "#282828"
        property color m3inversePrimary: "#615d63"
        property color m3secondary: "#689d6a"
        property color m3onSecondary: "#282828"
        property color m3secondaryContainer: "#458588"
        property color m3onSecondaryContainer: "#d79921"
        property color m3tertiary: "#b16286"
        property color m3onTertiary: "#282828"
        property color m3tertiaryContainer: "#8f3f71"
        property color m3onTertiaryContainer: "#d3869b"
        property color m3error: "#cc241d"
        property color m3onError: "#282828"
        property color m3errorContainer: "#9d0006"
        property color m3onErrorContainer: "#ffdad6"
        property color m3primaryFixed: "#d79921"
        property color m3primaryFixedDim: "#b57614"
        property color m3onPrimaryFixed: "#1d1b1f"
        property color m3onPrimaryFixedVariant: "#49454b"
        property color m3secondaryFixed: "#689d6a"
        property color m3secondaryFixedDim: "#79740e"
        property color m3onSecondaryFixed: "#1d1b1d"
        property color m3onSecondaryFixedVariant: "#484648"
        property color m3tertiaryFixed: "#b16286"
        property color m3tertiaryFixedDim: "#8f3f71"
